...
class DBFAdapterTest(TestCase):
    ...
    def test_head_read(self):
        headers = json.loads(DBFAdapter._head(self._db_path, 'ULIZ.DBF', 'HR852'))
    ...
    def test_export(self):
        outcome = DBFAdapter._export(self._db_path, 'ULIZ.DBF', ['ULIZ01', 'ULIZ02', 'ULIZ03'], [], 'HR852')
    ...
    def test_update(self):
        ...
        with open(self._db_path + '/dbfadapter/update.json') as f:
            package = json.load(f)
            outcome = DBFAdapter._update(package, self._db_path, 'ULIZ.DBF', ['ULIZ01', 'ULIZ02', 'ULIZ03'], 'HR852')
...
class RFKAdapterTest(TestCase):
    ...
    def _set_up(self, table_name='ULIZ.DBF', with_headers=True, code_page='HR852'): 
